...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="flex w-full justify-center mt-[130px] pt-5 px-40 max-md:max-w-full max-md:mt-10 max-md:px-5">
      <div className="min-w-60 w-full max-w-[960px] overflow-hidden flex-1 shrink basis-[0%] max-md:max-w-full">
        <div className="min-h-[512px] w-full max-md:max-w-full">
          <div className="flex w-full flex-col items-stretch justify-center flex-1 p-4 max-md:max-w-full">
            <div className="flex flex-col relative min-h-[480px] w-full overflow-hidden pl-14 pr-6 pt-[232px] pb-[39px] rounded-xl max-md:max-w-full max-md:pt-[100px] max-md:px-5">
              <img
